...
% p1 = pos_neg;
% percent=10;
% [save_p,save_v,save_a,T_total]= get_movj_traj_dualArm(p0,p1,max_vel,acc_vel_rate,jerk_acc_rate,percent);
...
for i = 1:percent_num
    ...
    [save_p,save_v,save_a,T_total]= get_movj_traj_dualArmV2(p0,p1,max_vel,acc_vel_rate,jerk_acc_rate,percent);
    save_save_a = [save_save_a,save_a];
    save_save_v = [save_save_v,save_v];
    save_save_p = [save_save_p,save_p];
    save_T(cnt)=T_total;
...
dlmwrite(['dualArm_data_read_validation_dualArmV2','.txt'],save_data);
save(['dualArm_time_validation_dualArmV2.mat'],'percent_data','percent_num','save_T')
